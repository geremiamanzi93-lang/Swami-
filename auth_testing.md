# Cuore Artigiano - Auth Testing Playbook
...
curl -X GET "https://your-app.com/api/works"

curl -X POST "https://your-app.com/api/works" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"title": "Test Opera", "category": "Orecchini", "image_path": "test/path.jpg"}'
```
